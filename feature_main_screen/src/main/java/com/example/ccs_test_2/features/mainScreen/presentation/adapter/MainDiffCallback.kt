...
class MainDiffCallback:DiffUtil.ItemCallback<MainCurrencyRateItem>() {
    ...
    override fun areItemsTheSame(oldItem: MainCurrencyRateItem, newItem: MainCurrencyRateItem): Boolean {
        return oldItem.value == newItem.value
    }

    override fun areContentsTheSame(oldItem: MainCurrencyRateItem, newItem: MainCurrencyRateItem): Boolean {
